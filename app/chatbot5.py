...
# Fill NaNs and create context strings
texts = df.fillna("").apply(lambda row: f"Equipment {row['equipment_id']} is located at {row['location']}, owner: {row['asset_owner']}, ceased: {row['ceased']}, comment: {row['eng_comment']}", axis=1)
...
# -------------------------------------------
# Step 2: Load Local LLM (phi-1_5 or phi-2)
# -------------------------------------------
